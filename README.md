...
| `disableAutomaticFileInjection`         | boolean                                                                             |          | Whether to auto inject styles though a style tag in the head on component mount, when disabled you are encouraged to import the css file into you're project from the package it self, like sass/scss `@import "~react-easy-crop/react-easy-crop";`                                                         |
