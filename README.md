...
| `muted`                                                                   | boolean                                                                             |          | Whether the video should be muted or not. **If this is set to false, the video will not autoplay properly!**                                                                                                                                                                                                                                                                                               |
| `playing`                                                                 | boolean                                                                             |          | Whether the video should be playing or not. This also sets the autoplay property on the rendered video so that state stays synced between the parent and child.                                                                                                                                                                                                                                            |
