...
- [Basic example](https://ValentinH.github.io/react-easy-crop/docs/examples/basic)
- [Example with output of the cropped image](https://ValentinH.github.io/react-easy-crop/docs/examples/output)
- [Example with image selected by the user](https://ValentinH.github.io/react-easy-crop/docs/examples/upload)
- [Example with round crop area and no grid](https://ValentinH.github.io/react-easy-crop/docs/examples/round)
- [Example with a video](https://ValentinH.github.io/react-easy-crop/docs/examples/video)
- [Example with crop saved/loaded](https://ValentinH.github.io/react-easy-crop/docs/examples/restore)
...
| `objectFit`                                                              | 'contain', 'cover', 'horizontal-cover' or 'vertical-cover'                          |          | Specifies how the image is shown in the cropper. `contain`: the image will be adjusted to be fully visible, `horizontal-cover`: the image will horizontally fill the cropper, `vertical-cover`: the image will vertically fill the cropper, `cover`: we automatically pick between `horizontal-cover` or `vertical-cover` to have a fully visible image inside the cropper area. Defaults to "contain".    |
...
| `setMediaSize`                                                            | `(size: MediaSize) => void`                                                         |          | [Advanced Usage] Used to expose the `mediaSize` value for use with the `getInitialCropFromCroppedAreaPixels` and `getInitialCropFromCroppedAreaPercentages` functions.                                                                                                           |
| `setCropSize`                                                             | `(size: Size) => void`                                                              |          | [Advanced Usage] Used to expose the `cropSize` value for use with the `getInitialCropFromCroppedAreaPixels` and `getInitialCropFromCroppedAreaPercentages` functions.                                                                                                            |
