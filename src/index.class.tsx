...
class CropperClass extends React.Component<Props, State> {
  static defaultProps = {
    zoom: 1,
    rotation: 0,
    aspect: 4 / 3,
  ...
  onMouseDown = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    this.onDragStart(CropperClass.getMousePoint(e))
  }

  onMouseMove = (e: MouseEvent) => this.onDrag(CropperClass.getMousePoint(e))
  ...
  onTouchStart = (e: React.TouchEvent<HTMLDivElement>) => {
    ...
    if (e.touches.length === 2) {
      ...
      this.onDragStart(CropperClass.getTouchPoint(e.touches[0]))
    }
  }
  ...
  onTouchMove = (e: TouchEvent) => {
    ...
    if (e.touches.length === 2) {
      ...
      this.onDrag(CropperClass.getTouchPoint(e.touches[0]))
    }
  }
  ...
  onPinchStart(e: React.TouchEvent<HTMLDivElement>) {
    const pointA = CropperClass.getTouchPoint(e.touches[0])
    const pointB = CropperClass.getTouchPoint(e.touches[1])
  ...
  onWheel = (e: WheelEvent) => {
    e.preventDefault()
    const point = CropperClass.getMousePoint(e)
  ...
  getPointOnContainer = ({ x, y }: Point) => {
    if (!this.containerRect) {
      throw new Error('The CropperClass is not mounted')
    }
    return {
