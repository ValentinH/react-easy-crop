describe('Mouse assertions', function () {
  ...
  it('Limit the left drag if too far', function () {
    ...
    cy.get('img').should('have.css', 'transform', 'matrix(1, 0, 0, 1, -150.96, 0)')
  })
  ...
  it('Mouse wheel should zoom in and out following the pointer', function () {
    ...
    cy.get('img').should('have.css', 'transform', 'matrix(1.5, 0, 0, 1.5, 250, 130.89)')
    cy.get('[data-testid=container]').trigger('wheel', { deltaY: 50, clientX: 800, clientY: 400 })
    cy.get('img').should('have.css', 'transform', 'matrix(1.25, 0, 0, 1.25, 258.333, 65.445)')
  })
  ...
  it('Limit top after zoom ', function () {
    ...
    cy.get('img').should('have.css', 'transform', 'matrix(1.5, 0, 0, 1.5, 0, -130.89)')
  })
